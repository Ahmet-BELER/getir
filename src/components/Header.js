...
export default function Header() {
    return (
        <div className="bg-brand-color justify-center  ">
            ...
            <div className = "container mx-auto  h-11 flex items-center justify-between ">
                ...
                <nav className=" flex gap-x-8  text-sm font-semibold">
                    ...
                    <a href="/" class= " text-white text-opacity-80 transition-all hover:text-opacity-60 flex items-center gap-x-2" >
                    <BiGlobe size={20}/>
                        Türkçe (TR)
                    </a>
                    <a href="/" class="  text-white text-opacity-80 hover:text-opacity-60 flex items-center gap-x-2">
                        <RiUserFill size={20}/>
                        Giriş Yap
                    </a>
                    <a href="/" class=" text-white text-opacity-80 hover:text-opacity-60 flex items-center gap-x-2">
